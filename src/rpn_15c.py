...
"""
An implementation of a classic 15c RPN calculator.
...
class HP_Button( Static ):
    def __init__(self, label = "", f_label = "", g_label = "", id: str | None = None ):
        self.label = label
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="calculator"):
            ...
            with calc_buttons:
                ...
                yield HP_Button("4", "x≷", "SF", id="digit-4")
                yield HP_Button("5", "DSE", "CF", id="digit-5")
